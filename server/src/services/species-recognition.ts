...
const SPECIES: Record<SpeciesId, Info> = {
  ...
  Anemone: { sci: "Actinia equina", common: "Beadlet anemone", alts: ["Anemonia viridis", "Urticina felina"] },
  Octopus: { sci: "Octopus vulgaris", common: "Common octopus", alts: ["Eledone cirrhosa", "Octopus bimaculoides"] },
  Urchin: { sci: "Paracentrotus lividus", common: "Purple sea urchin", alts: ["Echinus esculentus", "Arbacia lixula"] },
  Nudibranch: { sci: "Facelina auriculata", common: "Facelina nudibranch", alts: ["Aeolidia papillosa", "Polycera quadrilineata"] },
  Seahorse: { sci: "Hippocampus hippocampus", common: "Short-snouted seahorse", alts: ["Hippocampus guttulatus", "Hippocampus kuda"] },
  Shark: { sci: "Scyliorhinus canicula", common: "Small-spotted catshark", alts: ["Galeorhinus galeus", "Prionace glauca"] },
  Dolphin: { sci: "Tursiops truncatus", common: "Bottlenose dolphin", alts: ["Delphinus delphis", "Stenella coeruleoalba"] },
